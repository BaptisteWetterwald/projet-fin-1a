            ...
            adapter = new ArrayAdapter<Topic>(AdminActivity.this, R.layout.list_item, R.id.itemTextView, themes) {
                ...
                public View getView(int position, View convertView, ViewGroup parent) {
                    ...
                    Database.getInstance().get(Table.TOPIC_USERS.getName(), TopicUser.class, new String[]{"topic"}, new Topic[]{themes.get(position)}).addOnSuccessListener(topicUsers -> {
                            ...
                            TextView themeTitle = finalView.findViewById(R.id.itemTextView);
                            ...
                            Button editButton = finalView.findViewById(R.id.editButton);
                            Button deleteButton = finalView.findViewById(R.id.deleteButton);
                            Button changeModeratorButton = finalView.findViewById(R.id.changeModeratorButton);
