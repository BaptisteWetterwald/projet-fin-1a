...
public class LoginActivityTest {
    ...
    @Test
    public void testTextFieldInputValid() throws InterruptedException {
        // Protocol to test
    ...
    @Test
    public void testTextFieldInputInvalidMail() throws InterruptedException {
        // Protocol to test
        onView(withId(R.id.editTextLoginUsername)).perform(clearText());
        ...
        //onView(Matchers.allOf(withText(""), isDisplayed()));
        //onView(ViewMatchers.withText("Invalid MAL")).check(matches(isDisplayed()));
    }
